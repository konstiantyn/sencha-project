        ...
        var eventBindings = function(){
            ...
            webix.ui({
                ...
                body    : {
	                ...
	                data        : [
		                {id: 1, value: "Help",  icon:'question-circle'},
		                {id: 2, value: "About", icon:'info'}
	                ],
	                select      : true,
	                on:{
        ...
        var guiConnect  = function(){
                 ...
                 if(cDynamicData.settings.t_c_check == true){
                    b.push({ 
                     ...
                     b.push({
                        ...
                        height      : 40,
                        css         : 'tcText',
                        template    : "* "+i18n('sBy_continuing_cm_you_agree_to_the_terms_and_conditions_fs')+'<br>'
                    });
           ...
           webix.ui({
                ...
                head:{
					view:"toolbar", cols:[
					    {},
						{ view: 'button', type: 'icon', icon:"close", width: 40,  align: 'right',click:"$$('winLogin').hide();"}
						]
				},
				body : {
		                minWidth    : cMinWidth,
        ...
        var guiHelp     = function(){ 
            ...
            webix.ui({
                ...
                head:{
					view:"toolbar", cols:[
					    {},
						{ view: 'button', type: 'icon', icon:"close", width: 40,  align: 'right',click:"$$('winHelp').hide();"}
						]
				},
				body : { 
                    view        : "form",
        ...
        var guiAbout    = function(){
            ...
            webix.ui({
                ...
                head    : {
					view:"toolbar", cols:[
					    {},
						{ view: 'button', type: 'icon', icon:"close", width: 40,  align: 'right',click:"$$('winAbout').hide();"}
						]
				},
				body : { 
                    view    :"form",
