...
$config['Meshes']['captive_portal']['radius_1']         = '159.203.36.19'; // This will be the public IP Address of the FreeRADIUS / RADIUSdesk
...
$config['Meshes']['captive_portal']['uam_url']          = 'http://159.203.36.19/cake2/rd_cake/dynamic_details/chilli_browser_detect/'; 
