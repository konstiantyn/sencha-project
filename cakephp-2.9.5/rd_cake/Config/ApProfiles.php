...
$config['ApProfiles']['captive_portal']['radius_1']         = '159.203.36.19'; // This will be the public IP Address of the FreeRADIUS / RADIUSdesk
...
$config['ApProfiles']['captive_portal']['uam_url']          = 'http://159.203.36.19/cake3/rd_cake/dynamic-details/chilli-browser-detect/'; 
...
$config['common_ap_settings']['heartbeat_interval']     = 60; //Send a heartbeat pulse through every interval seconds
